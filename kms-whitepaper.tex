...
\author{\IEEEauthorblockN{Michael Egorov}
\IEEEauthorblockA{NuCypher,\\
Email: michael@nucypher.com}
\and
\IEEEauthorblockN{MacLane Wilkison}
\IEEEauthorblockA{NuCypher,\\
Email: maclane@nucypher.com}
\and
\IEEEauthorblockN{David Nu{\~n}ez}
\IEEEauthorblockA{NICS Lab, Universidad de M{\'a}laga, Spain,\\
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\columnwidth]{pdf/miners-ruler.pdf}
...
\bibliography{IEEEabrv,kms-whitepaper}
